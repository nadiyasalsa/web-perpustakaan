<aside class="main-sidebar sidebar-light-dark elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/adminlte/dist/img/logoperpus.png" alt="Logo Perpus" class="brand-image img-circle elevation-3" style="opacity: .8 " >
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/adminlte/dist/img/foto.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/dashboard" class="nav-link @yield('active-dashboard')" style="background: linear-gradient(to left, #C3ACD0, #674188);">
